      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-1">
            {matchSkills.map(s => (
              <Badge key={s} variant="outline" className="px-1.75 py-0.5 bg-emerald-500/10 border-emerald-500/25 rounded text-[11px] text-emerald-500 font-normal">
                {s}
              </Badge>
            ))}
      ...
      >
        ...
        <div className="p-5 px-6 border-b border-[var(--border)] shrink-0">
            ...
            <div className="flex flex-wrap gap-1.5 mb-3.5">
              <Badge variant="outline" className="px-2 py-0.75 rounded text-[11px] font-semibold font-mono" style={{ background: workTypeColor[job.workType] + '20', color: workTypeColor[job.workType] }}>
                {job.workType}
              </Badge>
              <Badge variant="outline" className="px-2 py-0.75 rounded text-[11px] font-semibold font-mono" style={{ background: (parserColor[job.parser] || '#64748b') + '20', color: parserColor[job.parser] || '#64748b' }}>
                via {job.parser}
              </Badge>
              ...
              {job.salary && (
                <Badge variant="outline" className="px-2 py-0.75 rounded text-[11px] font-semibold bg-emerald-500/12 text-emerald-500 font-mono">
                  {job.salary}
                </Badge>
              )}
            </div>
